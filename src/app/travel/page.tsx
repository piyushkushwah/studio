    ...
    <div className="w-full bg-background p-4 md:p-8 flex flex-col">
      <header className="w-full flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div className="flex items-center gap-3">
          <Link href="/">
            <Button variant="ghost" size="icon" className="rounded-xl text-emerald-600 hover:bg-emerald-50/50 hover:text-emerald-600 transition-colors">
          ...
          <ScrollArea className="max-h-[90vh]">
            <div className="p-8 space-y-8 bg-card">
              ...
              <DialogFooter className="flex gap-3 pt-4">
                <Button variant="ghost" className="h-12 px-6 rounded-xl font-bold uppercase text-[10px] tracking-widest hover:bg-muted/50 hover:text-primary" onClick={() => setIsDialogOpen(false)}>
                  Discard
                </Button>
                <Button 
                  onClick={handleSave} 
                  disabled={!formData.destination.trim()}
                  className="h-12 px-8 rounded-xl font-bold bg-emerald-600 hover:bg-emerald-700 shadow-xl shadow-emerald-200 flex-1 transition-all active:scale-[0.98]"
                >
